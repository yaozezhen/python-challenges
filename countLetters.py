# first play with what's below
txt = input("Type something to test this out: ")
print("Did you just type", txt)
# delete the lines above once you understand how they work
...
def countLetters(word):
  # fill-in code here
  # leave the return statement below alone, feel free to delete this line
  return 
